...
![Main Build Status](https://img.shields.io/github/actions/workflow/status/ansible-lockdown/Windows-2019-CIS-TEST/windows_benchmark_testing_to_main.yml?label=Main%20Build%20Status)
